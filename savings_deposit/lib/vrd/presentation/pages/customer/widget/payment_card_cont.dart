...
//                         VrDcustomerEvent.updateChequeDate(
...
//                           .add(VrDcustomerEvent.updateChequeDate(depositdate));
//                       dateController.text =
//                           DateFormat('dd-MMM-yyyy').format(depositdate);
//                     }
//                   },
...
//                                         context
//                                             .read<VrDcustomerBloc>()
//                                             .add(VrDcustomerEvent.saveTokens(
...
//                                                         bank.accountNo));
//                                         context.read<VrDcustomerBloc>().add(
//                                             VrDcustomerEvent.updateBankBranchId(
//                                                 bankBranchId:
//                                                     bank.bankBranchId));
//                                         context.read<VrDcustomerBloc>().add(
//                                             VrDcustomerEvent
...
//                             onChanged: (newvalue) {
//                               context.read<VrDcustomerBloc>().add(
//                                   VrDcustomerEvent.subsidiaryBank(
...
//                       context
//                           .read<VrDcustomerBloc>()
//                           .add(VrDcustomerEvent.updateChqueNumber(value));
//                     },
//                     validator: ((value) {
//                       if (value!.isEmpty) {
...
//                           if (value.length >= 11) {
//                             context.read<VrDcustomerBloc>().add(
//                                 VrDcustomerEvent.fetchRdIfscCode(
//                                     ifscCode: value));
//                             context
//                                 .read<VrDcustomerBloc>()
//                                 .add(VrDcustomerEvent.updateIfscCode(value));
//                           }
//                         },
//                         validator: (value) {
//                           if (value!.isEmpty) {
