          ...
          child: Column(
            children: [
              ...
              state.newSdnomineeName == ""
                  ? const SizedBox()
                  : Text(
                      delegate.NsNomineeName + ": " + state.newSdnomineeName,
                      style: TextStyle(
                    ...
                    children: [
                      ...
                      BlocConsumer<CustomerBloc, CustomerState>(
                        listener: (context, state) {
                          state.nomineeRelationFailureOrSuccess.fold(
                              () => {},
                              (a) => a.fold(
                                  (l) => {
                                        l.map(
                        ...
                        builder: (context, state) {
                          return SizedBox(
                            ...
                            child: DropdownButton<dynamic>(
                              ...
                              items: state.nomineeRelationDataModel != null
                                  ? state.nomineeRelationDataModel!.data
                                      .map((e) {
